...
| [`retry`](https://pkg.go.dev/github.com/dpoage/llmkit/retry) | The shared retry loop: exponential backoff with jitter, `Retry-After` precedence, per-attempt timeouts. | [reference](https://pkg.go.dev/github.com/dpoage/llmkit/retry) |
